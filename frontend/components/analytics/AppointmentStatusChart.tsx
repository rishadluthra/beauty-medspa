...
export function AppointmentStatusChart() {
  ...
  if (isLoading) return <p className="text-brand-sage">Loading appointment status…</p>;
  if (!data || data.length === 0) return <p className="text-brand-sage">No appointment data yet.</p>;
